          ...
          */}
          ...
          <li>
            ...
            <ul className="submenu">
             ...
             {/*<li>
                <Link to={process.env.PUBLIC_URL + "/collections/collection1"}>
                Collection 1
                </Link>
              </li>
              <li>
                <Link to={process.env.PUBLIC_URL + "/collections/collection2"}>
                Collection 2
                </Link>
              </li>
              <li>
                <Link to={process.env.PUBLIC_URL + "/collections/collection3"}>
                Collection 3
                </Link>
              </li>
              <li>
                <Link to={process.env.PUBLIC_URL + "/collections/collection4"}>
                Collection 4
                </Link>
              </li>
              <li>
                <Link to={process.env.PUBLIC_URL + "/collections/collection5"}>
                Collection 5
                </Link>
              </li>
              <li>
                <Link to={process.env.PUBLIC_URL + "/collections/collection6"}>
                Collection 6
                </Link>
              </li>
              <li>
                <Link to={process.env.PUBLIC_URL + "/collections/collection7"}>
                Collection 7
                </Link>
              </li> */}
            </ul>
